...
import { cancelForgeSelectedCraftingBaseCard } from '../../../../sc_craft/src/state/actions.js';
...
export class ScForgingCraftingBaseCardOverlay extends LitElement {
  render() {
    return html`
      ${ScSharedStyles}
  ...
  _cancel() {
    localStore.dispatch(cancelForgeSelectedCraftingBaseCard());
  }
}

window.customElements.define('sc-forging-crafting-base-card-overlay', ScForgingCraftingBaseCardOverlay);
