...
import { cancelSelectMinionTargetedAbility } from '../../../../sc_cards/src/state/actions.js';
...
export class ScTargetMinionAbilityOverlay extends LitElement {
  render() {
    return html`
      ${ScSharedStyles}
  ...
  _cancel() {
    localStore.dispatch(cancelSelectMinionTargetedAbility());
  }
}

window.customElements.define('sc-target-minion-ability-overlay', ScTargetMinionAbilityOverlay);
